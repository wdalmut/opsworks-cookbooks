...
attribute "application_zf/zend/skeleton/repository",
  :display_name => "Use personal ZF skeleton application",
  :description => "Set the repository URL of your ZendSkeletonApplication",
  :default => "latest"
